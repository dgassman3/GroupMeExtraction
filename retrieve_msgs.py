...
TOKEN = 'KMnGLpkdF1IWptT96wYUmSiSOe4A4wtG41A7MCXQ'
	...
	while (curCount < totalCount):
		...
		for msg in msgs:
			...
			if user not in users:
				users[user] = []
			if csv_file:
				wr.writerow([group_name, created_at.encode('utf-8'), user.encode('utf-8'), name.encode('utf-8'), text.encode('utf-8'), likes])
